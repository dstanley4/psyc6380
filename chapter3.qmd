...
We do the glimpse a bit differently here. We sort the order of the columns alphabetically prior to doing the glimpse(). It  affects only the display of the column names, and not the data, because we did not have an arrow back into statedata2018.
