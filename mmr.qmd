...
3.  Plug both of those values into the [sample size calculation](https://dstanley4.github.io/psyc6380/mr-sample-size.html#sample-size-using-sr2) provided in the multiple regression lecture.