...
-   Focus on having sufficient power to find the variance accounted for by the set of predictors (i.e. $R^2$)

-   Focus on having sufficient power to find the unique variance account for by a single predictor (i.e. $sr^2$)
