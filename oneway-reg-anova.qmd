...
|--------------|------------------|------------------|--------| 
| Treatment Coding / Dummy Coding  |![](contr.treatment.png) |Intercept is the reference group mean. Unstandardized weights indicate difference between a group's mean and reference group mean. In this example, group 1 is the reference group. | Default in R. **Do NOT use for ANOVA.**|
| Sum Coding / Effect Coding  |![](contr.sum.png) | Intercept is the grand mean. Unstandardized weights indicate difference between a group's mean and last group's mean (Group 4 here). | Can use for ANOVA because intercept is the grand mean.| 
| Helmert Coding  |![](contr.helmert.png) | Intercept is the grand mean. First contrast, unstandardized weight indicate difference between Group 2 and Group 1 means. Second contrast, unstandardized weight indicate difference between Group 3 mean and the average of the Group 1 and Group 2 means. Third contrast, unstandardized weight indicate difference between Group 4 mean and the average of the Group 1, Group 2, and Group 3 means. And so on. | Can use for ANOVA because intercept is the grand mean.| 
