...
1.  `missing-data-by-item.csv`: A summary of missing data by item.
2.  `high-missing-participants.csv`: A list of participants with more than
    20% missing data. 
3.  `missing-data-map.pdf`: A visual map of missing data patterns.
