...
::: {.callout-tip}
## Using AI is Easier a Pipeline Approach
...
We can see the pairs plot created in the output folder called `figure-pairs-plot.png`. This visual map helps identify patterns in the missing data across items and participants.
